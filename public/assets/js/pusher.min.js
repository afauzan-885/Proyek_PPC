...
!(function (t, e) {
    ...
    return (function (t) {
        ...
        function (t, e, n) {
            ...
            (e.encode = function (t) {
                for (
                    var e = new Uint8Array(r(t)), n = 0, i = 0;
                    i < t.length;
                    i++
                ) {
        ...
        function (t, e, n) {
            ...
            class i {
                ...
                create(t) {
                    ...
                    return (
                        (this[e] = s),
                        { number: e, id: n, name: i, callback: s }
                    );
                }
                remove(t) {
            ...
            class Q {
                ...
                send(t) {
                    if (!this.request) {
                        ...
                        (this.request = ue.createScriptRequest(n)),
                            this.request.send(t);
                    }
                }
                cleanup() {
            ...
            var ut = new ht({
                ...
                mt = new ht(N({}, dt, bt)),
                yt = new ht(N({}, pt, bt));
            (gt.xdr_streaming = mt), (gt.xdr_polling = yt), (gt.sockjs = vt);
            var wt = gt;
            ...
            class Pt {
                ...
                finish(t, e) {
                    this.callback(
                        N({ transport: this.transport, action: t }, e)
                    );
                }
            }
            class Et {
                ...
                send(t, e) {
                    this.timeline.isEmpty() ||
                        this.timeline.send(
                            ue.TimelineTransport.getAgent(this, t),
                            e
                        );
                }
            }
                        ...
                        this.channels[t] ||
                            (this.channels[t] = (function (t, e) {
                                if (0 === t.indexOf("private-encrypted-")) {
                                    if (e.config.nacl)
                                        return Ht.createEncryptedChannel(
                                            t,
                                            e,
                                            e.config.nacl
                                        );
            ...
            var Yt = function (t, e, n) {
                    ...
                    var s,
                        ...
                        b = r("xhr_polling", "xhr_polling", 1, c),
                        m = r("xdr_polling", "xdr_polling", 1, c),
                        y = new zt([d], h),
                        w = new zt([p], h),
                        S = new zt([f], h),
                        _ = new zt([new Wt(Vt(g), g, v)], h),
                        k = new zt([new Wt(Vt(b), b, m)], h),
                        C = new zt(
                            [
                                new Wt(
                                    Vt(_),
                                    new qt([_, new $t(k, { delay: 4e3 })]),
                                    k
                                ),
                            ],
                            h
            ...
            class Qt extends at {
                ...
                close() {
                    this.unloader &&
                        (ue.removeUnloadListener(this.unloader),
                        (this.unloader = null)),
                        this.xhr &&
            ...
            var re,
                ...
                he = {
                    ...
                    createRequest: (t, e, n) => new Qt(t, e, n),
            ...
            class pe {
                ...
                connect(t, e) {
                    if (!this.isSupported()) return fe(new m(), e);
            ...
            var ve = function (t, e, n, i, r, s) {
                    ...
                    return (
                        !(
                            (t.enabledTransports &&
                                -1 === H(t.enabledTransports, e)) ||
                            (t.disabledTransports &&
                                -1 !== H(t.disabledTransports, e))
                        )
                            ? ((r = Object.assign(
            ...
            function Se(t, e) {
                let n = {
                    ...
                    useTLS: Ce(t),
                    wsHost: ke(t),
                    userAuthenticator: Ee(t),
                    channelAuthorizer: Oe(t, e),
                };
                return (
            ...
            const Pe = (t) => "customHandler" in t && null != t.customHandler;
            function Ee(t) {
                const e = Object.assign(
                    Object.assign({}, s.userAuthentication),
                    t.userAuthentication
                );
                return Pe(e) ? e.customHandler : me(e);
            }
            function Oe(t, e) {
                const n = (function (t, e) {
                    let n;
                    if ("channelAuthorization" in t)
                        n = Object.assign(
                        ...
                        return { customHandler: we(e, n, t.authorizer) };
                    return n;
                })(t, e);
                return Pe(n) ? n.customHandler : ye(n);
            }
            class xe extends at {
                constructor(t) {
                    super(function (t, e) {
            ...
            class Ae extends at {
                ...
                _newSigninPromiseIfNeeded() {
                    ...
                    if (this.signinDonePromise && !this.signinDonePromise.done)
                        return;
                    const { promise: t, resolve: e, reject: n } = Le();
                    t.done = !1;
                    const i = () => {
                        t.done = !0;
                    };
            ...
            class Re {
                static ready() {
                    Re.isReady = !0;
                    for (var t = 0, e = Re.instances.length; t < e; t++)
                        Re.instances[t].connect();
                }
                ...
                constructor(t, e) {
                    !(function (t) {
                        ...
                        (this.key = t),
                        (this.options = e),
                        (this.config = Se(this.options, this)),
                        ...
                        this.config.enableStats &&
                            (this.timelineSender = Ht.createTimelineSender(
                                this.timeline,
                                {
                                    host: this.config.statsHost,
                                    path:
                                        "/timeline/v2/" +
                                        ue.TimelineTransport.name,
                                }
                            ));
                    (this.connection = Ht.createConnectionManager(this.key, {
                        getStrategy: (t) =>
                            ue.getDefaultStrategy(this.config, t, ve),
                        timeline: this.timeline,
                        ...
                        this.timeline.info({ instances: Re.instances.length }),
                        (this.user = new Ae(this)),
                        Re.isReady && this.connect();
                }
                switchCluster(t) {
            ...
            (Re.instances = []),
                ...
                (Re.logToConsole = !1),
                (Re.Runtime = ue),
                (Re.ScriptReceivers = ue.ScriptReceivers),
